 ...
 *
 */
public abstract class ContactListener3d {
	 ...
	 */
	public abstract boolean beginContact(Contact3d contact);
	
	/**
	 * Called after the the collision is solved, and only if the previous method has returned true.
	 * @param contact The Contact representing all informations about the collision
	 */
	public abstract void endContact(Contact3d contact);
	
	public static class DummyListener extends ContactListener3d {
		public boolean beginContact(Contact3d contact) {
			return true;
		}
		public void endContact(Contact3d contact) {}
	}
